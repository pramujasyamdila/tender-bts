...
<div class="container">
    <div class="screen">
        ...
        <div class="screen__content">
            ...
            <?= form_open('vendor/auth/registrasi'); ?>
            <div class="login__field">
                <div class="login__icon">
                    <i class=" fas fa fa-user" style="font-size: 20px; padding-left:10px;"></i>
                </div>
                <input type="text" name="username_vendor" style="padding-left:40px;" class="login__input" placeholder="User Name">
                <small class="text-danger"><?= form_error('username_vendor') ?></small>
            </div>
            <div class="login__field">
                <div class="login__icon">
            ...
            <div class="login__field">
                <div class="login__icon">
                    <i class=" fas fa fa-phone" style="font-size: 20px; padding-left:10px;"></i>
                </div>
                <input type="text" name="telepon_vendor" style="padding-left:40px;" class="login__input" placeholder="Telepon">
                <small class="text-danger"><?= form_error('telepon_vendor') ?></small>
            </div>
            <div class="login__field">
                <div class="login__icon">
                    <i class=" fas fa fa-envelope" style="font-size: 20px; padding-left:10px;"></i>
                </div>
                <input type="email" name="email_vendor" style="padding-left:40px;" class="login__input" placeholder="Email">
                <small class="text-danger"><?= form_error('email_vendor') ?></small>
            </div>
            <center>
                ...
                <a class="button login__submit" href="<?= base_url('vendor/auth') ?>">
                    <span class="button__text">Kembali</span>
                    <div class="button__icon">
